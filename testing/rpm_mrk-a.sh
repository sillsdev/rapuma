...
# Create the project
rpm project KYU-MYMR-MRKA --manage add-project --targetPath ~/Publishing/testArea --media_type book --name 'Kayah Book of Mark example in the Burmese script'

# Install groups to render
rpm group KYU-MYMR-MRKA Mark --manage add --component_type usfm --cid_list mrk --source_id MYMR --source ~/Publishing/testArea/KYUM/pt_environ
rpm group KYU-MYMR-MRKA Intro --manage add --component_type usfm --cid_list int --source_id MYMR --source ~/Publishing/testArea/KYUM/pt_environ

# Create a binding group
rpm group KYU-MYMR-MRKA BOOK --manage add --component_type bind --cid_list "Intro Mark"
...
rpm group KYU-MYMR-MRKA Mark --manage update --force
...
rpm group KYU-MYMR-MRKA Intro --manage render
rpm group KYU-MYMR-MRKA Mark --manage render
rpm group KYU-MYMR-MRKA BOOK --manage bind --proof
