...
class ProjLog (object) :
    ...
    def __init__(self, local, userConf) :
        ...
        self.errorCodes     = {
            ...
            'COMP-115' : ['WRN', 'The [<<1>>] component is locked. It must be unlocked before any modifications can be made.'],
            'COMP-120' : ['MSG', 'The component [<<1>>] has been removed from the project along with all its subcomponents.'],
            ...
            'PREP-010' : ['ERR', 'The component specified [<<1>>] is not found. Process halting! - project.runPreprocess()'],
            ...
            'LOCK-020' : ['MSG', 'The lock setting on the [<<1>>] component has been set to [<<2>>].'],
            'LOCK-030' : ['WRN', 'The [<<1>>] component is not found. Lock NOT set to [<<2>>].'],
