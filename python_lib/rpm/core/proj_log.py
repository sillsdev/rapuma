...
class ProjLog (object) :
    ...
    def __init__(self, local, userConf) :
        ...
        self.errorCodes     = {
            ...
            'STYL-075' : ['WRN', 'Style file: [<<1>>] is not valid. Will attempt to find a valid one from another source.'],
            ...
            'POST-100' : ['MSG', 'The contents of the file [<<1>>] have been copied/extracted into the Scripts folder.'],
            'POST-105' : ['ERR', 'The contents of the file [<<1>>] failed to be copied/extracted into the Scripts folder. Install custom post processing script failed.'],
            'POST-110' : ['LOG', 'Post processing script: [<<1>>] has been installed into the Scripts folder and should be ready for use.'],
            'POST-115' : ['LOG', 'Force switch was set (-f). Post processing script: [<<1>>] has been installed into the Scripts folder and should be ready for use.'],
