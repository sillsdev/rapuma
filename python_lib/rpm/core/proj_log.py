...
class ProjLog (object) :
    ...
    def __init__(self, local, userConf) :
        ...
        self.errorCodes     = {
            ...
            'FONT-032' : ['ERR', 'Forced font [<<1>>] to be the primary font for the [<<2>>] component type.'],
            ...
            'FONT-040' : ['ERR', 'Font file [<<1>>.xml] not found in the font bundle. Process halted. (font.recordFont())'],
            'FONT-042' : ['MSG', '<<1>> font setup information was force added to project config'],
            ...
            'FONT-060' : ['MSG', 'The <<1>> font bundle has been force copied into the project font folder. - font.installFont()'],
            'FONT-062' : ['MSG', 'The <<1>> font bundle already exsits in the font folder. - font.installFont()'],
            'FONT-065' : ['ERR', 'Font install process failed. - font.installFont()'],
