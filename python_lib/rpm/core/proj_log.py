...
class ProjLog (object) :
    ...
    def __init__(self, local, userConf) :
        ...
        self.errorCodes     = {
            ...
            'POST-082' : ['ERR', 'The script file: [<<1>>] already exsists in the PostProcess folder. Cannot copy over old file. Please use -f (force) to remove it if you want to install a fresh or different file.'],
