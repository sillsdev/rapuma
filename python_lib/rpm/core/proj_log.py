...
class ProjLog (object) :
    ...
    def __init__(self, local, userConf) :
        ...
        self.errorCodes     = {
            ...
            'FONT-047' : ['MSG', 'The [<<1>>] font already has a listing in the configuration.'],
            ...
            'FONT-062' : ['MSG', 'The <<1>> font bundle already exsits in the font folder. - font.installFont()'],
            ...
            'STYL-010' : ['WRN', 'Style file [<<1>>] is already assigned to the [<<2>>] component type. Use -f (force) to make any changes.'],
            'STYL-020' : ['ERR', 'Style install operation failed. File not valid: [<<1>>]'],
            'STYL-030' : ['MSG', 'ParaTExt project style file [<<1>>] was installed into project.'],
            'STYL-035' : ['MSG', 'ParaTExt project style file [<<1>>] was force installed into project.'],
            'STYL-040' : ['WRN', 'No ParaTExt project style file could be found. A style file was auto-generated based on project source data.'],
            'STYL-050' : ['ERR', 'No suitable project style could be found or created. Operation failed, system halted!'],
            'STYL-060' : ['MSG', 'This is an unknown style type. Operation failed, system halted!'],
            'STYL-070' : ['MSG', 'The file [<<1>>] was forced copied to the project styles folder.'],
            'STYL-080' : ['MSG', 'The file [<<1>>] was copied to the project styles folder.'],
            'STYL-090' : ['LOG', 'The file [<<1>>] was set as the default style file for the [<<2>>] component type.'],
            'STYL-100' : ['ERR', 'Style file: [<<1>>] was not found. Operation failed.'],
            'STYL-105' : ['LOG', 'Style file: [<<1>>] was not found.'],
            'STYL-110' : ['MSG', 'No style file setting was found for the [<<1>>] component type. Nothing has been done.'],
            'STYL-120' : ['MSG', 'Force switch was set (-f). Style file: [<<1>>] was removed from the project and references removed from the [<<2>>] settings.'],
            'STYL-130' : ['LOG', 'Style file: [<<1>>] was removed from the [<<2>>] settings.'],
            'STYL-140' : ['ERR', 'Style file: [<<1>>] is not valid. Copy operation failed!'],
            ...
            'PREP-055' : ['MSG', 'No preprocesses registered for this component type [<<1>>].'],
            ...
            'POST-020' : ['ERR', 'Could not run post process, file not found: [<<1>>].'],
            ...
            'POST-080' : ['ERR', 'A file named [<<1>>] is already registered as the post process script for this component type. Please use -f (force) to remove it if you want to install a fresh or different script.'],
            'POST-081' : ['ERR', 'This script is already registered as the post process script for this component type. Please use -f (force) to reinstall a fresh or different script.'],
            'POST-082' : ['ERR', 'The script file: [<<1>>] already exsists in the Scripts folder. Cannot copy over old file. Please use -f (force) to remove it if you want to install a fresh or different file.'],
            'POST-085' : ['ERR', 'Source script not found: [<<1>>]'],
            'POST-090' : ['LOG', 'Copied in custom post process file: [<<1>>] into Scripts folder.'],
            'POST-100' : ['MSG', 'The contents of the file [<<1>>] have been extracted into the Scripts folder.'],
            'POST-105' : ['ERR', 'The contents of the file [<<1>>] failed to be extracted into the Scripts folder. Install custom post processing script failed.'],
            ...
            'POST-120' : ['MSG', 'Copied in default post process file: [<<1>>] into Scripts folder from source: [<<2>>].'],
