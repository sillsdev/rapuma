...
class ProjLog (object) :
    ...
    def __init__(self, local, userConf) :
        ...
        self.errorCodes     = {
            ...
            'FONT-047' : ['ERR', 'The [<<1>>] font already has a listing in the configuration.'],
            'FONT-050' : ['ERR', 'Halt! [<<1>>] not found. - font.copyInFont()'],
            'FONT-060' : ['MSG', 'The <<1>> font bundle has been copied into the project font folder. - font.installFont()'],
