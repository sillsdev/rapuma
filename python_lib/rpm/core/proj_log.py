...
class ProjLog (object) :
    ...
    def __init__(self, local, userConf) :
        ...
        self.errorCodes     = {
            ...
            'TEXT-070' : ['ERR', 'Unable to copy [<<1>>] to [<<2>>] - error in text.usfmCopy().'],
            'TEXT-080' : ['LOG', 'Validating text using the [<<1>>] style file. - text.usfmCopy().'],
            'TEXT-090' : ['LOG', 'Cleaning text with SFM paser pprint. - text.usfmCopy().'],
            'TEXT-100' : ['LOG', 'Normalizing Unicode text to the [<<1>>] form. - text.usfmCopy().'],
            ...
            'STYL-010' : ['MSG', 'The file [<<1>>] was set as the default style file for the [<<2>>] component type.'],
            'STYL-020' : ['ERR', 'Style file: [<<1>>] was not found. Operation failed.'],
            'STYL-030' : ['LOG', 'No style file setting was found so a default name of [<<1>>] was given to the target file name.'],
            'STYL-040' : ['WRN', 'Style file [<<1>>] is already assigned to the [<<2>>] component type. Use -f (force) to make any changes.'],
            'STYL-050' : ['MSG', 'The file [<<1>>] was forced copied to the project styles folder.'],
            'STYL-060' : ['MSG', 'The file [<<1>>] was copied to the project styles folder.'],
            'STYL-070' : ['ERR', 'Style file: [<<1>>] is not valid. Copy operation failed!'],
            'STYL-080' : ['ERR', 'Style install operation failed. File not valid: [<<1>>]'],
