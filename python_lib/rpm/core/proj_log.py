...
class ProjLog (object) :
    ...
    def __init__(self, local, userConf) :
        ...
        self.errorCodes     = {
            ...
            'PREP-005' : ['MSG', 'Unassigned error message.'],
            'PREP-010' : ['ERR', 'The component type specified [<<1>>] is not found. Process halting! - project.runPreprocess()'],
            'PREP-015' : ['MSG', 'Unassigned error message.'],
            'PREP-020' : ['ERR', 'Could not preprocess, file not found: [<<1>>].'],
            'PREP-025' : ['MSG', 'Unassigned error message.'],
            'PREP-030' : ['ERR', 'The component type [<<1>>] is locked and cannot be processed.'],
            'PREP-035' : ['MSG', 'Unassigned error message.'],
            'PREP-040' : ['ERR', 'The component [<<1>>] is locked and cannot be processed.'],
            'PREP-045' : ['MSG', 'Unassigned error message.'],
            ...
            'PREP-082' : ['ERR', 'The script file: [<<1>>] already exsists in the Preprocess folder. Cannot copy over old file. Please use -f (force) to remove it if you want to install a fresh or different file.'],
            'PREP-085' : ['ERR', 'Source script not found: [<<1>>]'],
            'PREP-090' : ['LOG', 'Copied in custom preprocess file: [<<1>>] into process folder.'],
            'PREP-100' : ['MSG', 'The contents of the file [<<1>>] have been extracted into the process folder.'],
            'PREP-105' : ['ERR', 'The contents of the file [<<1>>] failed to be extracted into the process folder. Install custom preprocessing script failed.'],
            'PREP-110' : ['MSG', 'Preprocessing script: [<<1>>] has been installed into the process folder and should be ready for use.'],
            'PREP-115' : ['MSG', 'Force switch was set (-f). Preprocessing script: [<<1>>] has been installed into the process folder and should be ready for use.'],
            'PREP-120' : ['MSG', 'Copied in default preprocess file: [<<1>>] into process folder from source: [<<2>>].'],
