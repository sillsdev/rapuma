...
rapuma group KYU-MYMR-MRKA Mark -c usfm -m add -i mrk -d MYMR -s ~/Publishing/testArea/KYUM/pt_environ
...
rapuma group KYU-MYMR-MRKA Mark -m update -f
...
rapuma group KYU-MYMR-MRKA Mark -m execute
# Backup the project
