...
class Ui_MenuProjectBackup(object):
    def setupUi(self, MenuProjectBackup):
        ...
        MenuProjectBackup.resize(279, 106)
        self.gridLayout = QtGui.QGridLayout(MenuProjectBackup)
        ...
        self.lineEditPid = QtGui.QLineEdit(MenuProjectBackup)
        self.lineEditPid.setObjectName("lineEditPid")
        self.gridLayout.addWidget(self.lineEditPid, 0, 1, 1, 2)
        spacerItem = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem, 1, 0, 1, 1)
        self.labelPid = QtGui.QLabel(MenuProjectBackup)
        self.labelPid.setObjectName("labelPid")
        self.gridLayout.addWidget(self.labelPid, 0, 0, 1, 1)

        self.retranslateUi(MenuProjectBackup)
        QtCore.QObject.connect(self.pushButtonCancel, QtCore.SIGNAL("clicked(bool)"), MenuProjectBackup.close)
        QtCore.QObject.connect(self.pushButtonOk, QtCore.SIGNAL("clicked()"), MenuProjectBackup.setupUi)
        QtCore.QMetaObject.connectSlotsByName(MenuProjectBackup)

    def retranslateUi(self, MenuProjectBackup):
        MenuProjectBackup.setWindowTitle(QtGui.QApplication.translate("MenuProjectBackup", "Rapuma - Backup Project", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButtonCancel.setText(QtGui.QApplication.translate("MenuProjectBackup", "Cancel", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButtonOk.setToolTip(QtGui.QApplication.translate("MenuProjectBackup", "Create a template from the selected project", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButtonOk.setText(QtGui.QApplication.translate("MenuProjectBackup", "OK", None, QtGui.QApplication.UnicodeUTF8))
        self.lineEditPid.setToolTip(QtGui.QApplication.translate("MenuProjectBackup", "ID of the project to be removed", None, QtGui.QApplication.UnicodeUTF8))
        self.labelPid.setText(QtGui.QApplication.translate("MenuProjectBackup", "Project ID", None, QtGui.QApplication.UnicodeUTF8))
