...
###############################################################################
    ...
    def getStaticScripInfo (self) :
        ...
        return {
                ...
                'cloudPush'     : ['Push data from this project to the cloud',      'rapuma project '       + pid + ' cloud     save '], 
    ...
    def getGrpScripInfo (self, gid) :
        ...
        return {
                ...
                'hyphenUpdate'  : ['Update hyphenation in a group.',                'rapuma group '     + pid + ' ' + gid + ' hyphenation   update '], 
