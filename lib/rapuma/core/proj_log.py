...
class ProjLog (object) :
    ...
    def __init__(self, local, userConf) :
        ...
        self.errorCodes     = {
            ...
            'GRUP-010' : ['WRN', 'The [<<1>>] group is locked. It must be unlocked before any modifications can be made or use (-f) force to override the lock.'],
            'GRUP-020' : ['ERR', 'Source path given for components used in [<<1>>] group not found!'],
